...
";
    ...
    {
        return new Source("", "layout/header/header.bar.links.logged.email.twig", "/var/www/xcart/skins/crisp_white/customer/layout/header/header.bar.links.logged.email.twig");
    }
}
