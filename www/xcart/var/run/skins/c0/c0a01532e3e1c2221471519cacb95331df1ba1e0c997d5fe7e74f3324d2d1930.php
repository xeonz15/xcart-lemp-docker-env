...
class __TwigTemplate_adc6417f6eacf5935e39ab4b6fe04c99e621ca081fe1e455eaf3b09cfdf8c655 extends \XLite\Core\Templating\Twig\Template
{
...
echo $templateWrapperStart;
            ...
            $this->loadTemplate("access_denied.twig", "/home/vagrant/next/output/xcart/src/skins/admin/center.twig", 21)->display($context);
            if ($templateWrapperText) {
                echo $this->getThis()->endMarker($fullPath, $templateWrapperText);
            }
        }
...
echo $templateWrapperStart;
            ...
            $this->loadTemplate("license_message.twig", "/home/vagrant/next/output/xcart/src/skins/admin/center.twig", 25)->display($context);
            if ($templateWrapperText) {
                echo $this->getThis()->endMarker($fullPath, $templateWrapperText);
            }
        }
...
";
    ...
    {
        return new Source("", "/home/vagrant/next/output/xcart/src/skins/admin/center.twig", "");
    }
}
