 ...
 * @see \XCart\Bus\Rebuild\Executor\Step\Rollback\EditionChange
 *
 * @Service\Factory(arguments={"logger"="XCart\Bus\Core\Logger\Rebuild"})
 * @RebuildScript(name="rollback")
 */
class RollbackScript extends AScript
{
    /**
    ...
    {
        return $scriptState->type === 'rollback' && $scriptState->isExecutable();
    }
}
