...
-->
<?php define('XLITE_EDITION_LNG', 'ru'); define('XC_INSTALL_GA', 'UA-63353285-1'); if (basename(__FILE__) != 'install.php') die('Failed to start...'); require_once __DIR__ . '/Includes/install/main.php'; exit; ?>
<head>
...
<p>If you require assistance with this issue, simply <a href="https://www.x-cart.com/create-online-store.html?utm_source=XC5Install&utm_medium=noPHP&utm_campaign=XC5Install" target="_blank" onclick="javascript: ga('send', 'event', 'INFO', 'RequestPersonalDemo', 'no-php');">request a personal demo</a>, and our team will create a store for you.</p>
<p>If you are familiar with PHP and want to try your hand at installing X-Cart by yourself, consider using <a href="https://www.mamp.info/" target="_blank">MAMP</a> or <a href="http://wampserver.com/" target="_blank">WAMP</a> as your local server. You can also deploy your store on <a href="shttp://www.x-cart.com/hosting.html" target="_blank">X-Cart hosting</a> or deploy it on the servers of one of our <a href="https://partners.x-cart.com/hosting-companies?utm_source=XC5Install&utm_medium=noPHP&utm_campaign=XC5Install" target="_blank">hosting partners</a>.</p>
